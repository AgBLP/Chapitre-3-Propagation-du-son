...
\begin{center}
    \includegraphics[scale=0.4]{Images/Signal_Diapason.PNG}
\end{center}}{0}
%\\
...
\begin{center}
    \includegraphics[scale=0.55]{Images/Signal_Diapason_periode.png}
\end{center}}{0}
%\\
...
\begin{center}
    \includegraphics[scale=0.4]{Images/Guitare_grave.PNG}
\end{center}
Voici pour le son aigu :
\begin{center}
    \includegraphics[scale=0.4]{Images/Guitare_aigu.PNG}
\end{center}}{0}
%\\
