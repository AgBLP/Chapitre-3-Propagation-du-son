...
%\vspace{-0.7cm}
%\centering
%     \includegraphics[width=0.3\textwidth]{Images/Eclair.JPG}
%   \end{wrapfigure}
...
\begin{multicols}{2}
    ...
    \begin{center}
        \includegraphics[scale=1.2]{Images/Timbres_2.PNG}
    \end{center}
\end{multicols}
...
\begin{center}
    \includegraphics[scale=0.65]{Images/Echelle_niveau_sonore.PNG}
\end{center}
\begin{Large}
    \ding{45}
